...
- Danh sách khách hàng lọc thêm được theo Thôn/Xóm (**chọn được nhiều mục cùng lúc, kèm nút "Chọn tất cả"/"Bỏ chọn tất cả"**) và theo **Nợ quá hạn** / **Gần đến hạn** (chỉ chọn được 1 trong 2, giống nút radio) để tra cứu nhanh.
...
- Lọc theo **Nợ quá hạn** / **Gần đến hạn** (chip cạnh bộ lọc Thôn/Xóm, chỉ chọn được 1 trong 2 — bấm mục này tự bỏ chọn mục kia; "Gần đến hạn" tính tới 45 ngày, hiện chữ nhỏ (16-45 ngày) hoặc khung vàng (trong 15 ngày) y hệt Tổng quan — Thôn/Xóm cũng có nút "Chọn tất cả"/"Bỏ chọn tất cả" để thao tác nhanh), có thể **sắp xếp** theo Gốc hoặc Lãi, tăng dần/giảm dần (nút "Sắp xếp") — dùng để tìm nhanh khoản vay lớn nhất/nhỏ nhất hoặc khách cần nhắc trước.
